...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 w-full">
      ...
      <div className={cn ("bg-darkish text-zinc-200 py-2 px-4" ,  isScrolled
            && "hidden"
            )}>
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center space-x-3">
            <Button size="icon" variant="ghost" className="h-8 w-8 text-zinc-200 hover:text-white bg-zinc-700">
              <svg
