...
export default function TraditionlPage() {
  return (
    <div className="mt-40">
      ...
      <AnimatedSection className="max-w-6xl mx-auto text-center py-14 container  ">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          The traditional dishes of Dikome Balue are a flavorful reflection of
          our cultural heritage and culinary traditions. Passed down through
          generations, these dishes are cherished for their unique flavors,
